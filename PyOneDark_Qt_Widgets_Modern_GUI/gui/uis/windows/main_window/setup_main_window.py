...
class SetupMainWindow:
    ...
    add_left_menus = [
        ...
        {
            "btn_icon" : "icon_arrow_right.svg",
            "btn_id" : "btn_word_book",
            "btn_text" : "단어장",
            "btn_tooltip" : "단어장으로 이동",
            "show_top" : True,
            "is_active" : False
        },
        {
    ...
    def setup_gui(self):
        ...
        # PUSH BUTTON HOBBY
        self.push_button_hobby = PyPushButton(
            text="취미에 관한 수어 학습하기",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.icon_2 = QIcon(Functions.set_svg_icon("dribbble.svg"))
        self.push_button_hobby.setMinimumHeight(100)
        self.push_button_hobby.setIcon(self.icon_2)

        def on_push_button_hobby_clicked():
            # Load Page1
            MainFunctions.set_page(self, self.ui.load_pages.page_5)

        self.push_button_hobby.clicked.connect(on_push_button_hobby_clicked)

        # PUSH BUTTON CHARACTER
        self.push_button_character = PyPushButton(
            text="성격에 관한 수어 학습하기",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.icon_3 = QIcon(Functions.set_svg_icon("smile.svg"))
        self.push_button_character.setMinimumHeight(100)
        self.push_button_character.setIcon(self.icon_3)

        # PUSH BUTTON FAMILY
        self.push_button_family = PyPushButton(
            text="가족관계에 대한 수어 학습하기",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
            bg_color_hover=self.themes["app_color"]["dark_three"],
        ...
        self.icon_4 = QIcon(Functions.set_svg_icon("users.svg"))
        self.push_button_family.setMinimumHeight(100)
        self.push_button_family.setIcon(self.icon_4)

        # PUSH BUTTON BORN
        self.push_button_born = PyPushButton(
            text="출생에 대한 수어 학습하기",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.icon_5 = QIcon(Functions.set_svg_icon("map-pin.svg"))
        self.push_button_born.setMinimumHeight(100)
        self.push_button_born.setIcon(self.icon_5)

        # PUSH BUTTON AGE
        self.push_button_age = PyPushButton(
            text="연령대에 대한 수어 학습하기",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
            bg_color_hover=self.themes["app_color"]["dark_three"],
        ...
        self.icon_6 = QIcon(Functions.set_svg_icon("bar-chart.svg"))
        self.push_button_age.setMinimumHeight(100)
        self.push_button_age.setIcon(self.icon_6)

        # PUSH BUTTON LANGUAGE
        self.push_button_language = PyPushButton(
            text="언어에 대한 수어 학습하기",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.icon_7 = QIcon(Functions.set_svg_icon("globe.svg"))
        self.push_button_language.setMinimumHeight(100)
        self.push_button_language.setIcon(self.icon_7)

        self.ui.load_pages.p_4_row_1.addWidget(self.push_button_hobby)
        self.ui.load_pages.p_4_row_1.addWidget(self.push_button_character)
        self.ui.load_pages.p_4_row_1.addWidget(self.push_button_family)
        self.ui.load_pages.p_4_row_1.addWidget(self.push_button_born)
        self.ui.load_pages.p_4_row_1.addWidget(self.push_button_age)
        self.ui.load_pages.p_4_row_1.addWidget(self.push_button_language)
